...
namespace Cinebook.Migrations
{
    ...
    [Migration("20240325165801_Updated-Cinema-Logo-URL")]
    partial class UpdatedCinemaLogoURL
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cinebook.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            movieId = 1,
                            ProducerId = 1,
                            endDate = new DateTime(2024, 4, 24, 22, 28, 0, 749, DateTimeKind.Local).AddTicks(47),
                            movieCategory = 5,
                            ...
                            price = 250.0,
                            startDate = new DateTime(2023, 11, 26, 22, 28, 0, 749, DateTimeKind.Local).AddTicks(26)
                        },
                        new
                        {
                            movieId = 2,
                            ProducerId = 2,
                            endDate = new DateTime(2024, 4, 24, 22, 28, 0, 749, DateTimeKind.Local).AddTicks(54),
                            movieCategory = 2,
                            ...
                            price = 200.0,
                            startDate = new DateTime(2024, 2, 24, 22, 28, 0, 749, DateTimeKind.Local).AddTicks(52)
                        },
                        new
                        {
                            movieId = 3,
                            ProducerId = 3,
                            endDate = new DateTime(2024, 5, 24, 22, 28, 0, 749, DateTimeKind.Local).AddTicks(60),
                            movieCategory = 1,
                            ...
                            price = 300.0,
                            startDate = new DateTime(2024, 4, 24, 22, 28, 0, 749, DateTimeKind.Local).AddTicks(58)
                        });
                });
