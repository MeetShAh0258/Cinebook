...
namespace Cinebook.Migrations
{
    ...
    [Migration("20240323101651_second")]
            ...
            modelBuilder.Entity("Cinebook.Models.Cinema", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            cinemaPictureURL = "https://m.media-amazon.com/images/M/MV5BNjE3NDQyOTYyMV5BMl5BanBnXkFtZTcwODcyODU2Mw@@._V1_FMjpg_UX1000_.jpg"
                        },
                        new
                        {
                            cinemaId = 2,
                            ...
                            cinemaPictureURL = "https://media.licdn.com/dms/image/C5603AQHadjWvyBiX5g/profile-displayphoto-shrink_800_800/0/1592130902477?e=2147483647&v=beta&t=gtZwZ8XguQLYuQanGqzkJdDh330xW2i1oivtRpF37SM"
                        },
                        new
                        {
                            cinemaId = 3,
                            ...
                            cinemaPictureURL = "https://m.media-amazon.com/images/M/MV5BMTY5NzZmMmUtMzNlMS00MDdlLTg1ZTYtZjBkMWE1MDAwYjQ1XkEyXkFqcGdeQXVyMTE0MzQwMjgz._V1_QL75_UX500_CR0,0,500,281_.jpg"
                        });
                });
            ...
            modelBuilder.Entity("Cinebook.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            movieId = 1,
                            ProducerId = 1,
                            endDate = new DateTime(2024, 4, 22, 15, 46, 51, 98, DateTimeKind.Local).AddTicks(1488),
                            movieCategory = 5,
                            ...
                            price = 250.0,
                            startDate = new DateTime(2023, 11, 24, 15, 46, 51, 98, DateTimeKind.Local).AddTicks(1465)
                        },
                        new
                        {
                            movieId = 2,
                            ProducerId = 2,
                            endDate = new DateTime(2024, 4, 22, 15, 46, 51, 98, DateTimeKind.Local).AddTicks(1495),
                            movieCategory = 2,
                            ...
                            price = 200.0,
                            startDate = new DateTime(2024, 2, 22, 15, 46, 51, 98, DateTimeKind.Local).AddTicks(1494)
                        },
                        new
                        {
                            movieId = 3,
                            ProducerId = 3,
                            endDate = new DateTime(2024, 5, 22, 15, 46, 51, 98, DateTimeKind.Local).AddTicks(1501),
                            movieCategory = 1,
                            ...
                            price = 300.0,
                            startDate = new DateTime(2024, 4, 22, 15, 46, 51, 98, DateTimeKind.Local).AddTicks(1500)
                        });
                });
