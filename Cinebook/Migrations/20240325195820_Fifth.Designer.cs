...
namespace Cinebook.Migrations
{
    ...
    [Migration("20240325195820_Fifth")]
    partial class Fifth
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cinebook.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CinemaId = 2,
                            ProducerId = 1,
                            endDate = new DateTime(2024, 4, 25, 1, 28, 19, 825, DateTimeKind.Local).AddTicks(6634),
                            movieCategory = 5,
                            ...
                            price = 250.0,
                            startDate = new DateTime(2023, 11, 27, 1, 28, 19, 825, DateTimeKind.Local).AddTicks(6613)
                        },
                        new
                        {
                            movieId = 2,
                            CinemaId = 3,
                            ProducerId = 2,
                            endDate = new DateTime(2024, 4, 25, 1, 28, 19, 825, DateTimeKind.Local).AddTicks(6645),
                            movieCategory = 2,
                            ...
                            price = 200.0,
                            startDate = new DateTime(2024, 2, 25, 1, 28, 19, 825, DateTimeKind.Local).AddTicks(6643)
                        },
                        new
                        {
                            movieId = 3,
                            CinemaId = 1,
                            ProducerId = 3,
                            endDate = new DateTime(2024, 5, 25, 1, 28, 19, 825, DateTimeKind.Local).AddTicks(6652),
                            movieCategory = 1,
                            ...
                            price = 300.0,
                            startDate = new DateTime(2024, 4, 25, 1, 28, 19, 825, DateTimeKind.Local).AddTicks(6650)
                        },
                        new
                        {
                            movieId = 4,
                            CinemaId = 3,
                            ProducerId = 1,
                            endDate = new DateTime(2024, 4, 25, 1, 28, 19, 825, DateTimeKind.Local).AddTicks(6659),
                            movieCategory = 5,
                            movieDescription = "Oppenheimer is a 2023 epic biographical thriller film which follows the life of J. Robert Oppenheimer, the American theoretical physicist who helped develop the first nuclear weapons during World War II.",
                            movieName = "Oppenheimer",
                            moviePictureURL = "https://m.media-amazon.com/images/M/MV5BMDBmYTZjNjUtN2M1MS00MTQ2LTk2ODgtNzc2M2QyZGE5NTVjXkEyXkFqcGdeQXVyNzAwMjU2MTY@._V1_FMjpg_UX1000_.jpg",
                            price = 250.0,
                            startDate = new DateTime(2023, 11, 27, 1, 28, 19, 825, DateTimeKind.Local).AddTicks(6657)
                        });
                });
